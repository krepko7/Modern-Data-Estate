...
- [Lab 5 - Create code free data transformations using ADF and Data Flows - To be edited by Kirby](https://docs.microsoft.com/en-us/azure/data-factory/tutorial-data-flow#create-a-pipeline-with-a-data-flow-activity)
